...
public class Exercicio05 {
    public static void main(String[] args) {
        ...
        Arq.openWrite("u00_Nivelamento/ArquivosJava/ex5.txt");
        Arq.printString("teste");
        Arq.close();

        Arq.openRead("u00_Nivelamento/ArquivosJava/ex5.txt");
        ...
        Arq.openWrite("u00_Nivelamento/ArquivosJava/ex5copia.txt");
